...
class AlbumSongsAdapter : ListAdapter<LibrarySong, AlbumSongsAdapter.ViewHolder>(LibraryMediaDiffUtilCallback()) {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val albumThumbImageView: AppCompatImageView = view.findViewById(R.id.album_thumb)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.album_songs_adapter_view_holder, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.albumInfoTextView.text = song.artist.name ?: context.getString(R.string.unknown_artist)
        ...
        holder.overflow.setOnClickListener {
            showMediaPopupMenu(holder.overflow, context, song)
        }
